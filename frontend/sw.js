...
const CACHE_NAME = 'tasktracker-shell-v6';
const SHELL_FILES = [
  './', './index.html', './manifest.webmanifest',
  './style.css?v=9', './dashboard-v2.css?v=3', './mobile-v2.css?v=2', './mobile-v3.css?v=1',
  ...
  './budget.js', './analytics.js', './offline.js?v=2', './dashboard-v2.js?v=3',
