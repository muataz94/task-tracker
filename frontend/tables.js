...
const SHEET_FIELDS = {
  ...
  POs: [
    ...
    { key: 'actual_delivery',   label: 'Actual Delivery',   type: 'date',     layout: 'half' },
    { key: 'delivery_address',  label: 'Delivery Address',  type: 'datalist', sources: [['POs','delivery_address']], layout: 'half' },
    { key: 'vendor_contact',    label: 'Vendor Contact',    type: 'text',     layout: 'half' },
